...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    secondary: 'bg-gray-100 hover:bg-gray-200 text-gray-800 border border-transparent focus:ring-gray-400',
    danger: 'bg-rose-600 hover:bg-rose-700 text-white border border-transparent focus:ring-rose-500 shadow-sm',
